...
import LoginPage from "./packages/auth/pages/loginpage";
import RegisterPage from "./packages/auth/pages/registerpage";
import ForgotPasswordPage from "./packages/auth/pages/forgotpasswordpage";
...
import AuthSummaryPage from "./packages/auth/pages/summarypage";
